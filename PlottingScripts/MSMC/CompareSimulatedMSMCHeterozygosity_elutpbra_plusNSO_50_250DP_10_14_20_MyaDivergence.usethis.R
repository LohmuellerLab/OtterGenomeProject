########## Calculate heterozygosity from simulations, and plot:
elutCol="#377EB8"
pbraCol="#4DAF4A"
elut2Col="#C77CFF"
...
Mus <- read.table("/Users/annabelbeichman/Documents/UCLA/Otters/GidgetDeNovoGenome/Genome_Manuscript/Tables/MutationRateGrid/averageMutationRateGrid.high.reasonable.low.10_14_20_MyaDivergence.txt",header=F)
...
################ Plot of "reasonable mu" simulation ############
...
############ for supplement: compare distributions of 100kb hets for two elut models ###########
######## Check out full distributions:
# 20180830: these are updated to use the mutation rate assoc with 14.4 mya ( 8.644114e-09) from the 5-cal phylogeny
# 20180813 : these are updated to be the 13Mya reasonable mu value (9.575018e-09) instead of the old 11mya divergence mu value (old: 1.131593e-08) 
...
# divide by 100000 because it's 100kb blocks:
