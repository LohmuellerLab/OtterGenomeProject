...
# this script and comments are based on following this guide: http://htmlpreview.github.io/?https://github.com/CMPG/polysel/blob/master/example_primates_homininae.html
...
#  try some correlations: total otter gene length, used sequence length, tree length:
...
###  not going to correct because correlations are very low (and similar to what Daub found and didn't correct for ) #######
...
#Furthermore, we don’t assign the genes to bins: (only do this if you're correcting biases)
...
######### NOW MOVE OVER TO REMOTE SERVER ##########
# on hoffman:
