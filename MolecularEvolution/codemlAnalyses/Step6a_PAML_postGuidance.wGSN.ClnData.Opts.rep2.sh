...
rep=2 # if you're running paml multiple times for convergence  
...
genericAlt=$wd/paml_generic_files/generic.codeml.alt.CleanData${clnData}.omega0.2.rep2.ctl
#### set up 
...
echo "FILTER MUST BE G, S or N(upper case)"
fi
