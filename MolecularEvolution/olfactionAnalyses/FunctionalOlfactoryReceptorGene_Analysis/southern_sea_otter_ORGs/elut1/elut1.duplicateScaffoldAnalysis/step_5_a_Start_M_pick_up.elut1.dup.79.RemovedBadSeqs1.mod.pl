...
### CHANGED NAME TO REMOVEDBADSEQS1 SINCE SKIPPED STEP (2) WAS UNNECESSARY
my $foldername='./';
...
my @array = grep(/step_4_result_mafftAligment.20171103.removedBadSeqs1.fasta$/,readdir(FOLDER));
close FOLDER;
