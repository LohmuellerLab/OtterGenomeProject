...
write.table(classI.final,"step_9_FinalFunctionalList/elut2.classI.final.ORs.passedInspection.txt",quote=F,row.names=F,col.names=F)
write.table(classII.final,"step_9_FinalFunctionalList/elut2.classII.final.ORs.passedInspection.txt",quote=F,row.names=F,col.names=F)
write.table(c(as.character(classI.final),as.character(classII.final)),"step_9_FinalFunctionalList/elut2.classI.and.classII.final.ORs.passedInspection.txt",quote=F,row.names=F,col.names=F)
