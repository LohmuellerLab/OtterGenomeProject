...
trimIndex=31 #index 31 for elut2 # 0-based index of where you want to trim
r = 1e-08
Len = 30000000
num=60
blocksPerGroup=10
groups=num/blocksPerGroup
input=pd.read_table("/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingNorthernSeaOtterReadsToFerret/MSMC_50_250DPFilter_simsInSppDIrs/output_20190215/elut2.msmc.out.final.txt")
input.head()
...
print("model=elut2.msmc.trimAncient."+str(mu))
print("mkdir -p ${model}")
...
print("# northern sea otter msmc model -- trimmed msmc")
print("mu="+str(mu))
print("r="+str(r))
print("Na="+str(Na))
print("rho=" +str(rho))
