#! /bin/bash
#$ -cwd
#$ -l h_rt=40:00:00,h_data=20G,highp
#$ -N variantFiltering
...
#$ -M ab08028
#$ -t 1-323
#usage : script <genotype-rundate> <sample size in individuals after bad ind. removed(!!!)> 
rundate=20190215_nso_lib283only # date you called genotypes
ss=1  # POTENTIAL FOR ERRORS HERE; CHECK ss value carefully!!! 

# usage qsub script.sh <date you called genotypes in format YYYYMMDD> 
MEM=10G # memory requirement 
# set variables
