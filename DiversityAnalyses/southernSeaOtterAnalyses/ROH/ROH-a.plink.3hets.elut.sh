...
mkdir -p $wd
vcf=/u/flashscratch/a/ab08028/otters/vcfs/vcf_${date}_50_250DPFilter/HQSitesOnly-MaskedBadVariantsIndels/${PREFIX}.raw_variants.${i}.${date}.HQsites.Only.rmDotGenotypes.rmBadVars.vcf.gz
...
# window allows 5 missing calls, ; allowing 3 het calls
