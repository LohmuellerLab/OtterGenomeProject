...
outdir=/u/flashscratch/a/ab08028/otters/vcfs/vcf_${rundate}_50_250DPFilter/vep-output
mkdir -p $outdir
### heterozygotes:
...
# previously (and for pbra) did VEP differently. Argh why !
