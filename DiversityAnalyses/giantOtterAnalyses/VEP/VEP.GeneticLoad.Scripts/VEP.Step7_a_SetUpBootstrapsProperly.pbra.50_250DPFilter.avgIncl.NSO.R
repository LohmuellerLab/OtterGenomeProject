...
prefix="PteBra_1"
date="20171206"
datadir="/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingGiantOtterReadsToFerret/VEP/VEP-50_250DPFilter_canon_cds/includesShared/loadCalcs_includesSharedVars/" ### make specific to elut or pbra 
dir.create(paste(datadir,spp,"_derivedAllele_bootstraps/",sep=""))
inputFile=paste(datadir,"PteBra_1.20171206.VepResultsCountSummary.IncludesShared.txt",sep="")
...
coding_homAlt_perchunk <- read.table("/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingGiantOtterReadsToFerret/genome-stats/calculatingCodingCallableSites/countCallableCDSRegions_50_250DPFilter/pbra.callableSites.ferretCDSRegions.VariantHoms.txt",header=T)
coding_homAlt_total <- sum(coding_homAlt_perchunk$callableCDSSites)
coding_homAlt_total

coding_homRef_perchunk <- read.table("/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingGiantOtterReadsToFerret/genome-stats/calculatingCodingCallableSites/countCallableCDSRegions_50_250DPFilter/pbra.callableSites.ferretCDSRegions.NonVariant.HomRefs.txt",header=T)
coding_homRef_total <- sum(coding_homRef_perchunk$callableCDSSites)
coding_homRef_total

coding_het_perchunk <- read.table("/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingGiantOtterReadsToFerret/genome-stats/calculatingCodingCallableSites/countCallableCDSRegions_50_250DPFilter/pbra.callableSites.ferretCDSRegions.VariantHets.txt",header=T)
coding_het_total <- sum(as.numeric(coding_het_perchunk$callableCDSSites))
coding_het_total

# check totals add up:
pbra_total_coding_callable == coding_het_total + coding_homAlt_total + coding_homRef_total # TRUE 
...
dim(inputData)[1]==pbra_total_coding_callable # 30070013 should equal total coding sites. Good!
# write this out:
