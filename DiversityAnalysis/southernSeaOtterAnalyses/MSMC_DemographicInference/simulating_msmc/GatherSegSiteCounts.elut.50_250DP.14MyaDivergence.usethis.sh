...
reasonableMu=8.644114e-09 #20180828 update: reasonable mu based on 14.4 Mya divergence time from 5-cal phylogeny (4 year gen time)

mu=$reasonableMu
mods="full trimAncient trimAncient.rmBneck"
