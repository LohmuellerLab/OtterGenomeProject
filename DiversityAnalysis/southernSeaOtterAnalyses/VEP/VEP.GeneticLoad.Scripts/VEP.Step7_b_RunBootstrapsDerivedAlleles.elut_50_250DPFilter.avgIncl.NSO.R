...
### Files needed:
# 1. file with coding sites categories/# derived alleles (from step 7a) (example path for elut: /Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingGidgetReadsToFerret/VEP/VEP-50_250DPFilter_canon_cds/includesShared/elut_derivedAllele_bootstraps/elut.forBootstraps.StrippedDownDataset.AllCallableSites.derivedCountfromVEP.Annotation.50_250DPFilter.AvgIncl.NSO.txt)
# 2. file with average coding callable sites number (based on all three species) (/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/resultsCombining_all3Otters_inclNSO/VEP/TotalCodingCallableSites.and.averageCodingCallableSiteselut1pbra.50_250DPFilter.elut2.20-250xFilter.txt)
# on hoffman: 
# mkdir /u/flashscratch/a/ab08028/otters/vcfs/vcf_[date]/bootstrapDerivedAlleles/
# and use cyberduck or rsync to transfer the two files there
...
#dir.create(datadir)
# get average coding callable from file: (need to put this file on Hoffman) ## this is the NEW averages taht INCLUDE elut2 !!! (2010201)
...
bootstrapDerivedAllelesCount <- function(inputFile,nboot,nsites){
  ...
  for(i in seq(1,nboot)){
    ...
    # also want to count homs and hets in each category...?
    ...
    # speed it up, not counting the not-annotated category
