...
trimIndex=20 # 0-based index of where you want to trim 
...
input=pd.read_table("/Users/annabelbeichman/Documents/UCLA/Otters/RawReadsToGenotypes_Dec2016/mappingGiantOtterReadsToFerret/MSMC_DemographicInference_WholeGenome/output_20180209_50_250DPFilter/giant_otter.msmc.out.final.txt")
input.head()
...
print("model=pbra.msmc.trimAncient."+str(mu))
print("mkdir -p ${model}")
...
print("# giant otter msmc model -- full msmc")
print("mu="+str(mu))
print("r="+str(r))
print("Na="+str(Na))
print("rho=" +str(rho))
