...
# This script as written takes two input bam files to be merged, so edit as needed. 20171114: edited to remove second Bam for PBra
...
BAM_OUT=$2
cd $BAM_DIR
# took out from below first INPUT: #INPUT=$BAM_DIR/$BAM2 
